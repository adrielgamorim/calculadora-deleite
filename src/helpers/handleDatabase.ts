...
export async function addDocument(collectionName: string, data: Ingredient) {
  const collectionRef = collection(db, collectionName);
...
export async function updateDocument(collectionName: string, id: string, data: Partial<Ingredient>) {
